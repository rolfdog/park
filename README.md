...
wget https://github.com/rolfdog/park/blob/master/LeisureCoin_mn_install_multi.sh && chmod 777 LeisureCoin_mn_install_multi.sh && ./LeisureCoin_mn_install_multi.shhttps://github.com/rolfdog/park/blob/master/LeisureCoin_mn_install_multi.sh
